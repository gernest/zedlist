...
func jobsUpdateHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "jobs/update.html", size: 1369, mode: os.FileMode(420), modTime: time.Unix(1504864470, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func jobsViewHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "jobs/view.html", size: 1845, mode: os.FileMode(420), modTime: time.Unix(1504867394, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
