...
func authRegisterHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "auth/register.html", size: 1408, mode: os.FileMode(420), modTime: time.Unix(1504549624, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func jobsNewHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "jobs/new.html", size: 1076, mode: os.FileMode(420), modTime: time.Unix(1504549737, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
