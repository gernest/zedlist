...
module.exports=function(){return{props:["status","text"],data:function(){return{hasMessage:!0}},methods:{destroyMessage:function(s){this.set("hasMessage",!1)}}}};

},{}],2:[function(require,module,exports){
var options={};options=function(e){return require("./flash.js")()}(),options.render=function(e){var t=this,s=t.get("status"),n=t.get("text");return t.get("hasMessage")?e("div",{attrs:{}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n"),e("div",{attrs:{class:"ui transition message "+s}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n    "),e("div",{attrs:{class:"header"}},{shouldRender:!0},[e("#text",{shouldRender:!0},""+n)]),e("#text",{shouldRender:!0},"\n    "),e("i",{attrs:{class:"close icon"}},{shouldRender:!0,eventListeners:{click:[function(e){t.callMethod("destroyMessage",[e])}]}},[]),e("#text",{shouldRender:!0},"\n ")]),e("#text",{shouldRender:!0},"\n ")]):e("#text",{shouldRender:!1},"")},module.exports=function(e){e.component("flash",options)};

},{"./flash.js":1}],3:[function(require,module,exports){
function title(){return{data:function(){return{title:"",action:"Create",next:store.state.next,hasFlash:!1,flashText:"",flashStatus:""}},computed:{showForm:{get:function(){return 0==this.get("next")}}},hooks:{init:function(){var t=this;bus.on(keys.NEXT_FORM,function(e){t.set("next",e.next)})}},methods:{updateTitle:function(t){this.set("title",t.target.value)},create:function(t){var e=this.get("store");e.dispatch(keys.BEGIN_CREATE_RESUME);var s=this.get("title"),r=this;http.sendJSON("POST","/resume/new",{profileID:e.state.profileId,title:s}).then(function(t){e.dispatch(keys.CREATE_RESUME_SUCCESS,t),e.dispatch(keys.NEXT_FORM)},function(t){r.set("hasFlash",!0),r.set("flashText","some fish"),r.set("flashStatus","error"),e.dispatch(keys.CREATE_RESUME_FAILED)})}},store:store}}var http=require("../http.js"),store=require("../store/store.js"),keys=require("../store/constants.js"),bus=require("../store/bus.js");module.exports=title;

},{"../http.js":5,"../store/bus.js":7,"../store/constants.js":8,"../store/store.js":9}],4:[function(require,module,exports){
var options={};options=function(e){return require("./title.js")()}(),options.render=function(e){var t=this,s=t.get("flashStatus"),n=t.get("flashText"),d=t.get("hasFlash"),r=t.get("store");t.get("event");return t.get("showForm")?e("div",{attrs:{class:"row nice-box"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n    "),e("h2",{attrs:{class:"ui dividing header"}},{shouldRender:!1},[e("#text",{shouldRender:!1}," create a new resume ")]),e("#text",{shouldRender:!0},"\n    "),d?e("flash",{attrs:{status:""+s,text:""+n}},{shouldRender:!0},[]):e("#text",{shouldRender:!1},""),e("#text",{shouldRender:!0},"\n    "),e("form",{attrs:{method:"post",class:"ui large "+r.state.resume.loading+" form"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n        "),e("div",{attrs:{class:"field"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n            "),e("label",{attrs:{}},{shouldRender:!1},[e("#text",{shouldRender:!1},"title")]),e("#text",{shouldRender:!0},"\n            "),e("input",{attrs:{type:"text",name:"title"}},{shouldRender:!0,eventListeners:{change:[function(e){t.callMethod("updateTitle",[e])}]}},[]),e("#text",{shouldRender:!0},"\n        ")]),e("#text",{shouldRender:!0},"\n        "),e("button",{attrs:{class:"ui fluid large primary submit button"}},{shouldRender:!0,eventListeners:{click:[function(e){e.preventDefault(),t.callMethod("create",[e])}]}},[e("#text",{shouldRender:!0}," "+r.state.resume.action+" ")]),e("#text",{shouldRender:!0},"\n    ")]),e("#text",{shouldRender:!0},"\n")]):e("#text",{shouldRender:!1},"")},module.exports=function(e){e.component("title",options)};

},{"./title.js":3}],5:[function(require,module,exports){
function sendJSON(n,e,t){var a;return null!==t&&(a=JSON.stringify(t)),$.ajax({type:n,url:e,data:a,headers:{Accept:"application/json","Content-Type":"application/json"}})}module.exports.sendJSON=sendJSON;

},{}],6:[function(require,module,exports){
var Moon=require("moonjs");require("./components/flash.moon")(Moon),require("./components/title.moon")(Moon),new Moon({el:"#app"});

},{"./components/flash.moon":2,"./components/title.moon":4,"moonjs":12}],7:[function(require,module,exports){
var Moon=require("moonjs"),bus=new Moon;module.exports=bus;

},{"moonjs":12}],8:[function(require,module,exports){
module.exports.BEGIN_CREATE_RESUME="beginCreateResume",module.exports.CREATE_RESUME_SUCCESS="createResumeSuccess",module.exports.CREATE_RESUME_FAILED="createResumeFail",module.exports.NEXT_FORM="nextForm";

},{}],9:[function(require,module,exports){
var Moon=require("moonjs"),Monx=require("monx"),title=require("./title.js"),keys=require("./constants"),bus=require("./bus");Moon.use(Monx);var opts={state:{profileId:parseInt(localStorage.getItem("profileID")),next:0},actions:(obj={},obj[keys.NEXT_FORM]=function(e){e.next++,bus.emit(keys.NEXT_FORM,{next:e.next})},obj)},obj;title.init(opts);var store=new Monx(opts);module.exports=store;

},{"./bus":7,"./constants":8,"./title.js":10,"monx":11,"moonjs":12}],10:[function(require,module,exports){
var keys=require("./constants.js"),actions={};actions[keys.BEGIN_CREATE_RESUME]=function(e){e.resume.loading="loading"},actions[keys.CREATE_RESUME_SUCCESS]=function(e,s){e.resume.loading="",e.resume.action="Update",e.resume.value=s,e.resume.created=!0},actions[keys.CREATE_RESUME_FAILED]=function(e,s){e.resume.loading=""},module.exports.init=function(e){e.state.resume={title:"",value:{},created:!1,action:"Create",showProgress:!1,showForm:!0,loading:""},Object.assign(e.actions,actions)};

},{"./constants.js":8}],11:[function(require,module,exports){
/**
 * Monx v0.1.1
