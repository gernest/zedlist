...
function title(){return{data:function(){return{title:"",action:"Create"}},methods:{updateTitle:function(t){this.set("title",t.target.value)},create:function(t){var e=this.get("store");e.dispatch(keys.BEGIN_CREATE_RESUME);var s=this.get("title"),r=this;http.sendJSON("POST","/resume/new",{profileID:e.state.profileId,title:s}).then(function(t){e.dispatch(keys.CREATE_RESUME_SUCCESS,t),r.build()},function(t){console.log(t)})}},store:store}}var http=require("../http.js"),store=require("../store/store.js"),keys=require("../store/constants.js");module.exports=title;

},{"../http.js":3,"../store/constants.js":5,"../store/store.js":6}],2:[function(require,module,exports){
var options={};options=function(e){return require("./title.js")()}(),options.render=function(e){var t=this,s=t.get("messageState"),n=t.get("messageText"),d=t.get("hasMessage"),r=t.get("store");t.get("event");return e("div",{attrs:{class:"row nice-box"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n    "),e("h2",{attrs:{class:"ui dividing header"}},{shouldRender:!1},[e("#text",{shouldRender:!1}," create a new resume ")]),e("#text",{shouldRender:!0},"\n"),d?e("div",{attrs:{class:"ui transition message "+s}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n    "),e("div",{attrs:{class:"header"}},{shouldRender:!0},[e("#text",{shouldRender:!0},""+n)]),e("#text",{shouldRender:!0},"\n    "),e("i",{attrs:{class:"close icon"}},{shouldRender:!0,eventListeners:{click:[function(e){t.callMethod("destroyMessage",[e])}]}},[]),e("#text",{shouldRender:!0},"\n ")]):e("#text",{shouldRender:!1},""),e("#text",{shouldRender:!0},"\n    "),e("form",{attrs:{method:"post",class:"ui large "+r.state.resume.loading+" form"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n        "),e("div",{attrs:{class:"field"}},{shouldRender:!0},[e("#text",{shouldRender:!0},"\n            "),e("label",{attrs:{}},{shouldRender:!1},[e("#text",{shouldRender:!1},"title")]),e("#text",{shouldRender:!0},"\n            "),e("input",{attrs:{type:"text",name:"title"}},{shouldRender:!0,eventListeners:{change:[function(e){t.callMethod("updateTitle",[e])}]}},[]),e("#text",{shouldRender:!0},"\n        ")]),e("#text",{shouldRender:!0},"\n        "),e("button",{attrs:{class:"ui fluid large primary submit button"}},{shouldRender:!0,eventListeners:{click:[function(e){e.preventDefault(),t.callMethod("create",[e])}]}},[e("#text",{shouldRender:!0}," "+r.state.resume.action+" ")]),e("#text",{shouldRender:!0},"\n    ")]),e("#text",{shouldRender:!0},"\n")])},module.exports=function(e){e.component("title",options)};

},{"./title.js":1}],3:[function(require,module,exports){
...
var Moon=require("moonjs");require("./components/title.moon")(Moon),new Moon({el:"#app"});

},{"./components/title.moon":2,"moonjs":9}],5:[function(require,module,exports){
module.exports.BEGIN_CREATE_RESUME="beginCreateResume",module.exports.CREATE_RESUME_SUCCESS="createResumeSuccess";

},{}],6:[function(require,module,exports){
var Moon=require("moonjs"),Monx=require("monx"),title=require("./title.js");Moon.use(Monx);var opts={state:{profileId:parseInt(localStorage.getItem("profileID"))},actions:{}};title.init(opts);var store=new Monx(opts);module.exports=store;

},{"./title.js":7,"monx":8,"moonjs":9}],7:[function(require,module,exports){
var keys=require("./constants.js"),actions={};actions[keys.BEGIN_CREATE_RESUME]=function(e){e.resume.loading="loading"},actions[keys.CREATE_RESUME_SUCCESS]=function(e,s){e.resume.loading="",e.resume.action="Update",e.resume.value=s,e.resume.created=!0,console.log(s)},module.exports.init=function(e){e.state.resume={title:"",value:{},created:!1,action:"Create",showProgress:!1,showForm:!0,loading:""},Object.assign(e.actions,actions)};
